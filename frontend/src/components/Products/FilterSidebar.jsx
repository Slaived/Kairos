...
const FilterSidebar = () => {
    ...
    return (
        <div className='p-4'>
            <h3 className='text-xl font-medium text-gray-800 mb-4'>Filtro</h3>
            ...
            {/* Filtro de Género */}
            <div className='mb-6'>
                <label className='block text-gray-600 font-medium mb-2'>Género</label>
                {genders.map((gender) => (
            ...
            {/* Filtro de Talla */}
            <div className='mb-6'>
                <label className='block text-gray-600 font-medium mb-2'>Talla</label>
                {sizes.map((size) => (
