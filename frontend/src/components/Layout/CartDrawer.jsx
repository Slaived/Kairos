...
import { useNavigate } from 'react-router-dom'; // Asegúrate de que esta línea esté
                ...
                {cart && cart?.products?.length > 0 && (
                    <>
                        ...
                        <p className='text-sm tracking-tighter text-gray-600 mt-2 text-center'>
                            Los gastos de envío, los impuestos y
                            los códigos de descuento se calculan al finalizar la compra.
                        </p>
                    </>
                )}
            </div>
